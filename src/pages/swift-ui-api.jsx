...
export default function SwiftUIAPI() {
  useEffect(() => {
    if (!ExecutionEnvironment.canUseDOM) return;

    const iframe = document.querySelector('iframe[title="Swift UI SDK API Documentation"]');
    if (!iframe) return;
  ...
  return (
    <Layout title="Swift UI SDK API Reference">
      <iframe
        src="/swift-ui/documentation/modelhealthui/"
        style={{
          width: '100%',
        ...
        title="Swift UI SDK API Documentation"
      />
    </Layout>
  );
}
