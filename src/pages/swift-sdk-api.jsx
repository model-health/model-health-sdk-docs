...
export default function SwiftSDKAPI() {
  useEffect(() => {
    if (!ExecutionEnvironment.canUseDOM) return;

    const iframe = document.querySelector('iframe[title="Swift SDK API Documentation"]');
    if (!iframe) return;
  ...
  return (
    <Layout title="Swift SDK API Reference">
      <iframe
        ...
        title="Swift SDK API Documentation"
      />
    </Layout>
  );
}
