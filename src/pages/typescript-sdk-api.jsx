...
export default function TypeScriptSDKAPI() {
  useEffect(() => {
    if (!ExecutionEnvironment.canUseDOM) return;

    const iframe = document.querySelector('iframe[title="TypeScript SDK API Documentation"]');
    if (!iframe) return;
  ...
  return (
    <Layout title="TypeScript SDK API Reference">
      <iframe
        ...
        title="TypeScript SDK API Documentation"
      />
    </Layout>
  );
}
