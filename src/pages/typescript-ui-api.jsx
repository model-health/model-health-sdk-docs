...
export default function TypeScriptUIAPI() {
  useEffect(() => {
    if (!ExecutionEnvironment.canUseDOM) return;

    const iframe = document.querySelector('iframe[title="TypeScript UI SDK API Documentation"]');
    if (!iframe) return;
  ...
  return (
    <Layout title="TypeScript UI SDK API Reference">
      <iframe
        src="/viewer-react/modules.html"
        style={{
          width: '100%',
        ...
        title="TypeScript UI SDK API Documentation"
      />
    </Layout>
  );
}
