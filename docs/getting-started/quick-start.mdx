...
> **Python note:** Camera calibration, neutral pose calibration, and recording require a connected mobile device and are handled by the Model Health mobile app. The Python SDK is intended for post-capture workflows: listing sessions and subjects, running analysis on existing activities, and downloading results.
