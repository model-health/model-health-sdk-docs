...
> **Python note:** Neutral pose recording requires a connected mobile device and is not available in the Python SDK. You can create and manage subjects from Python; the neutral pose capture itself is handled by the Model Health mobile app.
...
<Tabs groupId="language">
  ...
  <TabItem value="python" label="Python">
  Neutral pose recording is not available in the Python SDK — it requires a connected mobile device. Use the Model Health mobile app to capture the neutral pose.
  </TabItem>
</Tabs>
