...
Subject calibration captures a neutral standing pose for each subject. This allows the SDK to personalize a 3D biomechanical model to the size of the subject, which is required for biomechanical analysis.
