...
Once an activity has been recorded and processed, you can run an analysis to extract meaningful metrics.
...
- And more... see `AnalysisType` in each language for all the supported types.
