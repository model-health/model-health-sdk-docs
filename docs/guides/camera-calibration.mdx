...
<Tabs groupId="language">
  ...
  Camera calibration is not available in the Python SDK. Use the Model Health mobile app to perform calibration, then list the resulting sessions via Python:
...
<Tabs groupId="language">
  ...
  <TabItem value="python" label="Python">
  Not applicable — camera calibration is performed via the mobile app.
  </TabItem>
</Tabs>
