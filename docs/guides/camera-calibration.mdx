...
> **Python note:** Camera calibration requires a connected mobile device and is not available in the Python SDK. Use the Model Health mobile app to calibrate cameras, then access the resulting sessions via Python.
