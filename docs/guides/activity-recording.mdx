...
> **Python note:** Starting and stopping recordings requires a connected mobile device and is not available in the Python SDK. Use the Model Health mobile app to record activities, then check processing status and run analysis from Python.
...
<Tabs groupId="language">
  ...
  Recording is not available in the Python SDK — it requires a connected mobile device. Use the Model Health mobile app to record activities, then retrieve them in Python:
